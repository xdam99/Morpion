...
function computerTurn() {
    ...
    for(let i=0; i < allCase.length; i++){
        ...
        if(XEnable == 1){
                ...
                if(case0.value == "X" && case1.value == "X" && case2.value == "X" && case3.value == ""){
                    valRandom = 3
                ...
                } else if(case1.value == "X" && case2.value == "X" && case3.value == "X" && case0.value == ""){
                    valRandom = 0
                    allCase[valRandom].disabled = true;
                    allCase[valRandom].style.backgroundColor = "#780000";
                    allCase[valRandom].style.color = "white";
                    return allCase[valRandom].value = "O";
                } else if(case4.value == "X" && case5.value == "X" && case6.value == "X" && case7.value == ""){
                    valRandom = 7
                    allCase[valRandom].disabled = true;
                    allCase[valRandom].style.backgroundColor = "#780000";
                    allCase[valRandom].style.color = "white";
                    return allCase[valRandom].value = "O";
                } else if(case5.value == "X" && case6.value == "X" && case7.value == "X" && case4.value == ""){
                    valRandom = 4
                    allCase[valRandom].disabled = true;
                    allCase[valRandom].style.backgroundColor = "#780000";
                    allCase[valRandom].style.color = "white";
                    return allCase[valRandom].value = "O";
                } else if(case8.value == "X" && case9.value == "X" && case10.value == "X" && case11.value == ""){
                    valRandom = 11
                    allCase[valRandom].disabled = true;
                    allCase[valRandom].style.backgroundColor = "#780000";
                    allCase[valRandom].style.color = "white";
                    return allCase[valRandom].value = "O";
                } else if(case9.value == "X" && case10.value == "X" && case11.value == "X" && case8.value == ""){
                    valRandom = 8
                    allCase[valRandom].disabled = true;
                    allCase[valRandom].style.backgroundColor = "#780000";
                    allCase[valRandom].style.color = "white";
                    return allCase[valRandom].value = "O";
                } else if(case12.value == "X" && case13.value == "X" && case14.value == "X" && case15.value == ""){
                    valRandom = 15
                    allCase[valRandom].disabled = true;
                    allCase[valRandom].style.backgroundColor = "#780000";
                    allCase[valRandom].style.color = "white";
                    return allCase[valRandom].value = "O";
                }   else if(case13.value == "X" && case14.value == "X" && case15.value == "X" && case12.value == ""){
                    valRandom = 12
                    allCase[valRandom].disabled = true;
                    allCase[valRandom].style.backgroundColor = "#780000";
                    allCase[valRandom].style.color = "white";
                ...
                else if(case0.value == "X" && case4.value == "X" && case8.value == "X" && case12.value == ""){
                    valRandom = 12
                    allCase[valRandom].disabled = true;
                    allCase[valRandom].style.backgroundColor = "#780000";
                    allCase[valRandom].style.color = "white";
                    return allCase[valRandom].value = "O";
                } else if(case4.value == "X" && case8.value == "X" && case12.value == "X" && case0.value == ""){
                    valRandom = 0
                    allCase[valRandom].disabled = true;
                    allCase[valRandom].style.backgroundColor = "#780000";
                    allCase[valRandom].style.color = "white";
                    return allCase[valRandom].value = "O";
                } else if(case1.value == "X" && case5.value == "X" && case9.value == "X" && case13.value == ""){
                    valRandom = 13
                    allCase[valRandom].disabled = true;
                    allCase[valRandom].style.backgroundColor = "#780000";
                    allCase[valRandom].style.color = "white";
                    return allCase[valRandom].value = "O";
                } else if(case5.value == "X" && case9.value == "X" && case13.value == "X" && case1.value == ""){
                    valRandom = 1
                    allCase[valRandom].disabled = true;
                    allCase[valRandom].style.backgroundColor = "#780000";
                    allCase[valRandom].style.color = "white";
                    return allCase[valRandom].value = "O";
                } else if(case2.value == "X" && case6.value == "X" && case10.value == "X" && case14.value == ""){
                    valRandom = 14
                    allCase[valRandom].disabled = true;
                    allCase[valRandom].style.backgroundColor = "#780000";
                    allCase[valRandom].style.color = "white";
                    return allCase[valRandom].value = "O";
                } else if(case6.value == "X" && case10.value == "X" && case14.value == "X" && case2.value == ""){
                    valRandom = 2
                    allCase[valRandom].disabled = true;
                    allCase[valRandom].style.backgroundColor = "#780000";
                    allCase[valRandom].style.color = "white";
                    return allCase[valRandom].value = "O";
                } else if(case3.value == "X" && case7.value == "X" && case11.value == "X" && case15.value == ""){
                    valRandom = 15
                    allCase[valRandom].disabled = true;
                    allCase[valRandom].style.backgroundColor = "#780000";
                    allCase[valRandom].style.color = "white";
                    return allCase[valRandom].value = "O";
                }   else if(case7.value == "X" && case11.value == "X" && case15.value == "X" && case3.value == ""){
                    valRandom = 3
                    allCase[valRandom].disabled = true;
                    allCase[valRandom].style.backgroundColor = "#780000";
                    allCase[valRandom].style.color = "white";
                ...
                else if(case0.value == "X" && case5.value == "X" && case10.value == "X" && case15.value == ""){
                    valRandom = 15
                    allCase[valRandom].disabled = true;
                    allCase[valRandom].style.backgroundColor = "#780000";
                    allCase[valRandom].style.color = "white";
                    return allCase[valRandom].value = "O";
                }  else if(case5.value == "X" && case10.value == "X" && case15.value == "X" && case0.value == ""){
                    valRandom = 0
                    allCase[valRandom].disabled = true;
                    allCase[valRandom].style.backgroundColor = "#780000";
                    allCase[valRandom].style.color = "white";
                    return allCase[valRandom].value = "O";
                }  else if(case3.value == "X" && case6.value == "X" && case9.value == "X" && case12.value == ""){
                    valRandom = 12
                    allCase[valRandom].disabled = true;
                    allCase[valRandom].style.backgroundColor = "#780000";
                    allCase[valRandom].style.color = "white";
                    return allCase[valRandom].value = "O";
                }  else if(case6.value == "X" && case9.value == "X" && case12.value == "X" && case3.value == ""){
                    valRandom = 3
                    allCase[valRandom].disabled = true;
                    allCase[valRandom].style.backgroundColor = "#780000";
                    allCase[valRandom].style.color = "white";
        ...
        if(OEnable == 1){
                if(case0.value == "O" && case1.value == "O" && case2.value == "O" && case3.value == ""){
                    valRandom = 3
                    allCase[valRandom].disabled = true;
                    allCase[valRandom].style.backgroundColor = "#003049";
                    allCase[valRandom].style.color = "white";
                    return allCase[valRandom].value = "X";
                } else if(case1.value == "O" && case2.value == "O" && case3.value == "O" && case0.value == ""){
                    valRandom = 0
                    allCase[valRandom].disabled = true;
                    allCase[valRandom].style.backgroundColor = "#003049";
                    allCase[valRandom].style.color = "white";
                    return allCase[valRandom].value = "X";
                } else if(case4.value == "O" && case5.value == "O" && case6.value == "O" && case7.value == ""){
                    valRandom = 7
                    allCase[valRandom].disabled = true;
                    allCase[valRandom].style.backgroundColor = "#003049";
                    allCase[valRandom].style.color = "white";
                    return allCase[valRandom].value = "X";
                } else if(case5.value == "O" && case6.value == "O" && case7.value == "O" && case4.value == ""){
                    valRandom = 4
                    allCase[valRandom].disabled = true;
                    allCase[valRandom].style.backgroundColor = "#003049";
                    allCase[valRandom].style.color = "white";
                    return allCase[valRandom].value = "X";
                } else if(case8.value == "O" && case9.value == "O" && case10.value == "O" && case11.value == ""){
                    valRandom = 11
                    allCase[valRandom].disabled = true;
                    allCase[valRandom].style.backgroundColor = "#003049";
                    allCase[valRandom].style.color = "white";
                    return allCase[valRandom].value = "X";
                } else if(case9.value == "O" && case10.value == "O" && case11.value == "O" && case8.value == ""){
                    valRandom = 8
                    allCase[valRandom].disabled = true;
                    allCase[valRandom].style.backgroundColor = "#003049";
                    allCase[valRandom].style.color = "white";
                    return allCase[valRandom].value = "X";
                } else if(case12.value == "O" && case13.value == "O" && case14.value == "O" && case15.value == ""){
                    valRandom = 15
                    allCase[valRandom].disabled = true;
                    allCase[valRandom].style.backgroundColor = "#003049";
                    allCase[valRandom].style.color = "white";
                    return allCase[valRandom].value = "X";
                }   else if(case13.value == "O" && case14.value == "O" && case15.value == "O" && case12.value == ""){
                    valRandom = 12
                    allCase[valRandom].disabled = true;
                    allCase[valRandom].style.backgroundColor = "#003049";
                    allCase[valRandom].style.color = "white";
                ...
                else if(case0.value == "O" && case4.value == "O" && case8.value == "O" && case12.value == ""){
                    valRandom = 12
                    allCase[valRandom].disabled = true;
                    allCase[valRandom].style.backgroundColor = "#003049";
                    allCase[valRandom].style.color = "white";
                    return allCase[valRandom].value = "X";
                } else if(case4.value == "O" && case8.value == "O" && case12.value == "O" && case0.value == ""){
                    valRandom = 0
                    allCase[valRandom].disabled = true;
                    allCase[valRandom].style.backgroundColor = "#003049";
                    allCase[valRandom].style.color = "white";
                    return allCase[valRandom].value = "X";
                } else if(case1.value == "O" && case5.value == "O" && case9.value == "O" && case13.value == ""){
                    valRandom = 13
                    allCase[valRandom].disabled = true;
                    allCase[valRandom].style.backgroundColor = "#003049";
                    allCase[valRandom].style.color = "white";
                    return allCase[valRandom].value = "X";
                } else if(case5.value == "O" && case9.value == "O" && case13.value == "O" && case1.value == ""){
                    valRandom = 1
                    allCase[valRandom].disabled = true;
                    allCase[valRandom].style.backgroundColor = "#003049";
                    allCase[valRandom].style.color = "white";
                    return allCase[valRandom].value = "X";
                } else if(case2.value == "O" && case6.value == "O" && case10.value == "O" && case14.value == ""){
                    valRandom = 14
                    allCase[valRandom].disabled = true;
                    allCase[valRandom].style.backgroundColor = "#003049";
                    allCase[valRandom].style.color = "white";
                    return allCase[valRandom].value = "X";
                } else if(case6.value == "O" && case10.value == "O" && case14.value == "O" && case2.value == ""){
                    valRandom = 2
                    allCase[valRandom].disabled = true;
                    allCase[valRandom].style.backgroundColor = "#003049";
                    allCase[valRandom].style.color = "white";
                    return allCase[valRandom].value = "X";
                } else if(case3.value == "O" && case7.value == "O" && case11.value == "O" && case15.value == ""){
                    valRandom = 15
                    allCase[valRandom].disabled = true;
                    allCase[valRandom].style.backgroundColor = "#003049";
                    allCase[valRandom].style.color = "white";
                    return allCase[valRandom].value = "X";
                }   else if(case7.value == "O" && case11.value == "O" && case15.value == "O" && case3.value == ""){
                    valRandom = 3
                    allCase[valRandom].disabled = true;
                    allCase[valRandom].style.backgroundColor = "#003049";
                    allCase[valRandom].style.color = "white";
                ...
                else if(case0.value == "O" && case5.value == "O" && case10.value == "O" && case15.value == ""){
                    valRandom = 15
                    allCase[valRandom].disabled = true;
                    allCase[valRandom].style.backgroundColor = "#003049";
                    allCase[valRandom].style.color = "white";
                    return allCase[valRandom].value = "X";
                }  else if(case5.value == "O" && case10.value == "O" && case15.value == "O" && case0.value == ""){
                    valRandom = 0
                    allCase[valRandom].disabled = true;
                    allCase[valRandom].style.backgroundColor = "#003049";
                    allCase[valRandom].style.color = "white";
                    return allCase[valRandom].value = "X";
                }  else if(case3.value == "O" && case6.value == "O" && case9.value == "O" && case12.value == ""){
                    valRandom = 12
                    allCase[valRandom].disabled = true;
                    allCase[valRandom].style.backgroundColor = "#003049";
                    allCase[valRandom].style.color = "white";
                    return allCase[valRandom].value = "X";
                }  else if(case6.value == "O" && case9.value == "O" && case12.value == "O" && case3.value == ""){
                    valRandom = 3
                    allCase[valRandom].disabled = true;
                    allCase[valRandom].style.backgroundColor = "#003049";
                    allCase[valRandom].style.color = "white";
